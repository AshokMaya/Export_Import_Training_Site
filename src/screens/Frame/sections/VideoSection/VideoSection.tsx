  ...
  return (
    <>
      ...
      <div className="w-full h-full relative hidden justify-center lg:flex">
        ...
        />
        <img
          className="absolute bottom-0 left-0 h-[55%] object-contain object-bottom pointer-events-none select-none z-20"
          src="/joseph-vijay-2.png"
          alt="joseph-vijay"
        />
        <img
          className="absolute bottom-0 right-6 h-[42%] object-contain object-bottom pointer-events-none select-none z-20"
          src="/image-5.png"
          alt="embelem"
        />
      </div>
